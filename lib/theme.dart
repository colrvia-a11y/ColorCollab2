...
class LightModeColors {
  static const lightPrimary = Color(0xFF2E7D32); // Paint green
  static const lightOnPrimary = Color(0xFFFFFFFF);
  static const lightPrimaryContainer = Color(0xFFE8F5E8);
  static const lightOnPrimaryContainer = Color(0xFF1B5E20);
  static const lightSecondary = Color(0xFF8D6E63); // Paint brush brown
  static const lightOnSecondary = Color(0xFFFFFFFF);
  static const lightTertiary = Color(0xFF5D4037); // Paint can brown
...
class DarkModeColors {
  static const darkPrimary = Color(0xFF66BB6A); // Light green for dark mode
  ...
  static const darkSecondary = Color(0xFFBCAAA4); // Light brown
  static const darkOnSecondary = Color(0xFF3E2723);
  static const darkTertiary = Color(0xFFA1887F); // Warm brown
